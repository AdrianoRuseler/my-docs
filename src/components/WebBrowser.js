      ...
      return (
        <div className={styles.mockPage}>
          <div className={styles.mockHeader}>
            ...
            {mockData.subtitle && <p className={styles.subtitle}>{mockData.subtitle}</p>}
          </div>
          <div className={styles.mockBody}>
            {mockData.sections?.map((section, index) => (
              ...
              <div className={styles.mockSection}>
                ...
                <p>This is a sample page demonstrating the web browser component. You can customize the content by passing mockData or content props.</p>
                <div className={styles.mockButtons}>
                  <button className={styles.mockButton}>Get Started</button>
                  <button className={styles.mockButtonSecondary}>Learn More</button>
                </div>
              </div>
            )}
          </div>
    ...
    <div className={styles.browser} style={{ height }}>
      ...
      <div className={styles.browserHeader}>
        <div className={styles.windowControls}>
          ...
          <span className={styles.windowButton} style={{ backgroundColor: '#27ca3f' }}></span>
        </div>
      ...
      {showNavigation && (
        <div className={styles.navigationBar}>
          ...
          <div className={styles.browserActions}>
            <button className={styles.actionButton} title="Bookmark">⭐</button>
            <button className={styles.actionButton} title="Menu">⋯</button>
          </div>
        </div>
      )}
